...
minimap2 forward.barcode.fa all.fastq.gz -t 20  -k7 -A1 -m42 -w1 -N8  >all.forward.sam &
minimap2 reverse.barcode.fa all.fastq.gz -t 20  -k7 -A1 -m42 -w1 -N8  >all.reverse.sam &
